...
export const VERSIONS=Object.freeze([
 {id:'chile-812',country:'chile',label:'Chile · V8.12',short:'V8.12',missions:10,latest:true,detail:'Avisos centrales breves: desaparecen en 0,75 segundos.',url:HOME+'play/chile-812/?ui=flash-r1'},
 ...
 {id:'france-lucien',country:'france',label:'Francia · V9.2 · Lucien nuevo',short:'LUCIEN NUEVO',missions:10,latest:true,detail:'Nuevo Lucien 3D y avisos breves de 0,75 segundos.',url:HOME+'play/france-lucien/?ui=flash-r1'},
 {id:'france-92',country:'france',label:'Francia · V9.2 original',short:'V9.2 ORIGINAL',missions:10,detail:'Lucien original y avisos breves de 0,75 segundos.',url:HOME+'play/france-92/?ui=flash-r1'},
